...
bind "unix:///tmp/turnofarmBE/sockets/puma.development.sock"
...
pidfile "/tmp/turnofarmBE/pids/puma.development.pid"
...
stdout_redirect "/turnofarmBE/log/puma.development.log", "/turnofarmBE/log/puma.development.err.log"
